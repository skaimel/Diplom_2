...
class TestCreateOrder:
    ...
    @allure.description('Создание заказа под авторизованным пользователем. Проверка статуса и тело ответа')
    def test_create_order_authorized_user_success(self, get_default_user):
        ...
        assert response_create_order.status_code == data.HTTP_OK
    ...
    def test_create_order_with_invalid_ingredients_internal_server_error(self, get_default_user):
        ...
        assert (
            response_create_order.status_code == data.HTTP_INTERNAL_SERVER_ERROR
    ...
    def test_create_order_without_ingredients_bad_request(self, get_default_user):
        ...
        assert (
            response_create_order.status_code == data.HTTP_BAD_REQUEST
    ...
    def test_create_order_unauthorized_user_success(self):
        ...
        assert (
            response_create_order.status_code == data.HTTP_OK
